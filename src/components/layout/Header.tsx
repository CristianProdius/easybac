          ...
          <div className="hidden lg:flex items-center space-x-8">
            {navItems.map((item, index) => (
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                href={item.href}
                className="text-gray-600 hover:text-[#377DFF] font-medium transition-colors relative group"
              >
                {item.title}
              ...
              <div className="py-4 space-y-4">
                {navItems.map((item, index) => (
                  <motion.a
                    ...
                    whileHover={{ x: 10 }}
                    href={item.href}
                    className="block text-gray-600 hover:text-[#377DFF] font-medium transition-colors"
                  >
                    {item.title}
                  </motion.a>
                ))}
